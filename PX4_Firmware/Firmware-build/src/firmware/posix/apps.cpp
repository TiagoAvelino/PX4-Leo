...
void init_app_map(apps_map_type &apps)
{
	...
	apps["ekf2"] = ekf2_main;
	apps["ekf2_replay"] = ekf2_replay_main;
	...
	apps["pid_att_control"] = pid_att_control_main;
	apps["lqr_att_control"] = lqr_att_control_main;
	...
	apps["px4_daemon_app"] = px4_daemon_app_main;
